...
local conf = {
    ...
    y = 0.39, -- Change to what you want (maximum value should be 0.65, otherwise you will have to change "playersPerPage")

    left = 0.13,
    right = 0.885, -- looks about right for the width used.
    center = 0.5
}
...
local playersPerPage = 24 -- The number of players to put onto a "page", max 14
...
function generatePage()
    ...
    for _,i in ipairs(pTable) do
        ...
        PushScaleformMovieFunctionParameterBool(false) -- Border
...
function draw()
    ...
    DrawScaleformMovie(scaleform, x, y, 0.20, 0.5, 255, 255, 255, 255)
end
