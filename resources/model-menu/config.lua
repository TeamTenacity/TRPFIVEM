...
menu_options = {
    ...
    {name = "Male models", f = listModels, param = male_models},
    {name = "Female models", f = listModels, param = female_models},
    --{name = "Animal models", f = listModels, param = animal_models},
    {name = "EMS models", f = listModels, param = ems_models},
    --{name = "Multiplayer models", f = listModels, param = mp_models},
    --{name = "Freemode models", f = listModels, param = freemode_models},
}
player_data  = {
...
local clothing_shops = {
    {name="Ped Editor", id=1, x=429.678, y=-811.652, z=29.4911},
    {name="Ped Editor", id=1, x=456.867, y=-990.814, z=28.891},
    {name="Ped Editor", id=1, x=1850.937, y=3683.613, z=33.089},
    {name="Ped Editor", id=1, x=1208.035, y=-1474.467, z=34.259},
}
incircle = false
    ...
    while true do
        ...
        for k,v in ipairs(clothing_shops) do
            if(Vdist(pos.x, pos.y, pos.z, v.x, v.y, v.z) < 15.0)then
                DrawMarker(25, v.x, v.y, v.z - 1, 0, 0, 0, 0, 0, 0, 1.0001, 1.0001, 0.5001, 1555, 0, 0,165, 0, 0, 0,0)
