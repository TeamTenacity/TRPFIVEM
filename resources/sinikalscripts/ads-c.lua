...
--  ad ('What you'll type in chat', 'CHAR_FLOYD', 'ImageName', 'Ad Title', 'Ad Subtitle'),
	...
	ad('traffic', 'CHAR_LS_TOURIST_BOARD', 'CHAR_LS_TOURIST_BOARD', 'Los Santos Traffic Information', 'Traffic Notice'),
	ad('dealership', 'CHAR_CARSITE', 'CHAR_CARSITE', 'Legendary Motors'),
	ad('lsc', 'CHAR_LS_CUSTOMS', 'CHAR_LS_CUSTOMS', 'LS Customs'),
	ad('ammunation', 'CHAR_AMMUNATION', 'CHAR_AMMUNATION', 'Ammunation', nil, true),
	ad('taxi', 'CHAR_TAXI', 'CHAR_TAXI', 'Taxi'),
	ad('sahp', 'CHAR_FLOYD', 'RDE_SAHP', 'SAHP Advisory', 'Phone Alert', true),
	ad('bcso', 'CHAR_FLOYD', 'RDE_BCSO', 'BCSO Advisory', 'Phone Alert', true),
	ad('fib', 'CHAR_FLOYD', 'RDE_FIB', 'FIB Advisory', 'Phone Alert', true),
	ad('lsia', 'CHAR_FLOYD', 'RDE_LSIA', 'LSIA Information', 'Phone Alert', true),
	ad('saspr', 'CHAR_FLOYD', 'RDE_SASPR', 'SASPR Advisory', 'Phone Alert', true),
	ad('store', 'CHAR_FLOYD', '247', '24/7 Shop'),
	ad('mw', 'CHAR_MP_MERRYWEATHER', 'CHAR_MP_MERRYWEATHER', 'Merryweather', nil, true),
	ad('onlyadmin', 'CHAR_BLOCKED', 'CHAR_BLOCKED', 'Administration', nil, true),
	ad('beekers', 'CHAR_MULTIPLAYER', 'CHAR_MULTIPLAYER', 'Beekers Garage', nil, true),
	ad('tow', 'CHAR_MULTIPLAYER', 'CHAR_MULTIPLAYER', 'Tow Truck', nil, true)
}
