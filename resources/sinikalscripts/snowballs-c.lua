...
Citizen.CreateThread(function()
    ...
    while true do
        ...
        if IsNextWeatherType('XMAS') then -- check for xmas weather type
            ...
            if IsControlJustReleased(0, 74) and not IsPedInAnyVehicle(GetPlayerPed(-1), true) and not IsPlayerFreeAiming(PlayerId()) then -- check if the snowball should be picked up
