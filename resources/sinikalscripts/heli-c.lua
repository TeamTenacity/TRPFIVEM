...
local lasheriffmav_hash = GetHashKey("lssheriffmav")
local sheriffmav_hash = GetHashKey("sheriffmav")
local hwaymav_hash = GetHashKey("hwaymav")
local noose_hash = GetHashKey("nooseannihilator")
local fbi_hash = GetHashKey("fbifrogger")
...
function IsPlayerInPolmav()
	...
	local vehicle = GetVehiclePedIsIn(lPed)
					if IsVehicleModel(vehicle, polmav_hash) or IsVehicleModel(vehicle, lasheriffmav_hash) or IsVehicleModel(vehicle, sheriffmav_hash) or IsVehicleModel(vehicle, hwaymav_hash) or IsVehicleModel(vehicle, noose_hash) or IsVehicleModel(vehicle, fbi_hash) then
					return true
					else
					return false
					end
