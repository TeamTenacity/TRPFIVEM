  ...
  if Config.EnableSocietyOwnedVehicles then
    ...
    ESX.TriggerServerCallback('esx_society:getVehiclesInGarage', function(vehicles)
      ...
      ESX.UI.Menu.Open(
        ...
        function(data, menu)
          ...
          ESX.Game.SpawnVehicle(vehicleProps.model, Config.Zones.VehicleSpawnPoint.Pos, 353.00, function(vehicle)
    ...
    ESX.UI.Menu.Open(
      'default', GetCurrentResourceName(), 'vehicle_spawner',
      {
        ...
        align    = 'bottom-right',
        elements = {
          {label = _U('ambulance1'),  value = 'ambulance'},
          {label = _U('ambulance2'),  value = 'ambulance2'},
          {label = _U('emssuv'),  value = 'emssuv'},
          {label = _U('emsvan'),  value = 'emsvan'},
          {label = _U('emscar'),  value = 'emscar'},
          {label = _U('emscar2'),  value = 'emscar2'},
          {label = _U('coroner'),  value = 'corspeedo'},
          {label = _U('firetruck'),  value = 'firetruk'},
          {label = 'Ladder Truck',  value = 'laddertruk'},
          {label = _U('lguard2'),  value = 'lguard2'},
          {label = _U('lguard'),  value = 'lguard'},
          {label = _U('blazer2'),  value = 'blazer2'},
        },
      },
      function(data, menu)
        menu.close()
