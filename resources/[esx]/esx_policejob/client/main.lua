...
function OpenCloakroomMenu()
  ...
  if PlayerData.job.grade_name == 'recruit' then
    table.insert(elements, {label = _U('cadet_wear'), value = 'cadet_wear_freemode'})
  end

  if PlayerData.job.grade_name == 'sahp' then
    table.insert(elements, {label = _U('statepd_wear'), value = 'statepd_wear_freemode'})
    table.insert(elements, {label = _U('statepd2_wear'), value = 'statepd2_wear_freemode'})
    table.insert(elements, {label = _U('statepd3_wear'), value = 'statepd3_wear_freemode'})
  end

  if PlayerData.job.grade_name == 'sapr' then
    table.insert(elements, {label = _U('ranger_wear'), value = 'ranger_wear_freemode'})
  end

  if PlayerData.job.grade_name == 'bcso' or PlayerData.job.grade_name == 'bcsohr' then
  	table.insert(elements, {label = 'BCSO Uniform', value = 'bcso_wear_freemode'})
  	table.insert(elements, {label = 'BCSO Motorcycle Uniform', value = 'bcso2_wear_freemode'})
  	table.insert(elements, {label = 'BCSO K9 Uniform', value = 'bcso3_wear_freemode'})
  	table.insert(elements, {label = 'BCSO Detective Uniform', value = 'bcso4_wear_freemode'})
  	table.insert(elements, {label = 'BCSO SEB Uniform', value = 'bcso5_wear_freemode'})
    table.insert(elements, {label = 'BCSO Gang / Narcotics Uniform', value = 'bcso6_wear_freemode'})
  end
  ...
  if PlayerData.job.grade_name == 'boss' then
    ...
    table.insert(elements, {label = _U('sheriff_wear'), value = 'police_wear_freemode'})
    table.insert(elements, {label = _U('lieutenant_wear'), value = 'polmoto_wear_freemode'})
    table.insert(elements, {label = _U('k9_wear'), value = 'k9_wear_freemode'})
    table.insert(elements, {label = _U('dick_wear'), value = 'dick_wear_freemode'})
    ...
    table.insert(elements, {label = _U('statepd2_wear'), value = 'statepd2_wear_freemode'})
    table.insert(elements, {label = _U('statepd3_wear'), value = 'statepd3_wear_freemode'})
    table.insert(elements, {label = 'LSPD/BCSO/SAHP Heavy Response', value = 'fbi3_wear_freemode'})
    table.insert(elements, {label = _U('ranger_wear'), value = 'ranger_wear_freemode'})
    table.insert(elements, {label = 'FIB Suit', value = 'fbi_wear_freemode'})
    table.insert(elements, {label = 'FIB Duty Vest', value = 'fbi2_wear_freemode'})
    table.insert(elements, {label = 'FIB SWAT', value = 'fbi4_wear_freemode'})
  end

  if PlayerData.job.grade_name == 'recruit' or PlayerData.job.grade_name == 'officer' or PlayerData.job.grade_name == 'corporal' or PlayerData.job.grade_name == 'sargeant' or PlayerData.job.grade_name == 'detective' or PlayerData.job.grade_name == 'lieutenant' or PlayerData.job.grade_name == 'fto' or PlayerData.job.grade_name == 'captain' or PlayerData.job.grade_name == 'astchief' then
    table.insert(elements, {label = _U('police_wear'), value = 'police_wear'})
    table.insert(elements, {label = _U('veste_wear'), value = 'veste_wear'})
    table.insert(elements, {label = _U('gilet_wear'), value = 'gilet_wear'})
    table.insert(elements, {label = _U('sheriff_wear'), value = 'police_wear_freemode'})
  ...
  if PlayerData.job.grade_name == 'fbi' then
    table.insert(elements, {label = 'FIB Suit', value = 'fbi_wear_freemode'})
    table.insert(elements, {label = 'FIB Suit', value = 'fbi5_wear_freemode'})
    table.insert(elements, {label = 'FIB Duty Vest', value = 'fbi2_wear_freemode'})
    table.insert(elements, {label = 'FIB Duty Vest', value = 'fbi6_wear_freemode'})
    table.insert(elements, {label = 'FIB Duty Vest', value = 'fbi7_wear_freemode'})
    table.insert(elements, {label = 'FIB SWAT', value = 'fbi4_wear_freemode'})
  end
  ...
  ESX.UI.Menu.Open(
    ...
    function(data, menu)
      ...
      if data.current.value == 'police_wear_freemode' then
        ESX.TriggerServerCallback('esx_skin:getPlayerSkin', function(skin, jobSkin)
      ...
      if data.current.value == 'fbi_wear_freemode' then
        ...
        if skin.sex == 0 then
          local model = GetHashKey("s_m_m_fiboffice_01")
      ...
      if data.current.value == 'fbi5_wear_freemode' then

        ESX.TriggerServerCallback('esx_skin:getPlayerSkin', function(skin, jobSkin)

        if skin.sex == 0 then
          local model = GetHashKey("s_m_m_fiboffice_03")
      ...
      if data.current.value == 'fbi6_wear_freemode' then

        ESX.TriggerServerCallback('esx_skin:getPlayerSkin', function(skin, jobSkin)

        if skin.sex == 0 then
          local model = GetHashKey("s_m_m_fibsec_02")
      ...
      if data.current.value == 'fbi7_wear_freemode' then

        ESX.TriggerServerCallback('esx_skin:getPlayerSkin', function(skin, jobSkin)

        if skin.sex == 0 then
          local model = GetHashKey("s_m_m_fibsec_03")
      ...
      if data.current.value == 'fbi2_wear_freemode' then
      ...
      if data.current.value == 'fbi3_wear_freemode' then

        ESX.TriggerServerCallback('esx_skin:getPlayerSkin', function(skin, jobSkin)

        if skin.sex == 0 then
          local model = GetHashKey("s_m_y_fibresponse_01")
      ...
      if data.current.value == 'fbi4_wear_freemode' then

        ESX.TriggerServerCallback('esx_skin:getPlayerSkin', function(skin, jobSkin)

        if skin.sex == 0 then
          local model = GetHashKey("s_m_y_fibswat_01")
      ...
      if data.current.value == 'bcso_wear_freemode' then
      ...
      if data.current.value == 'bcso2_wear_freemode' then

        ESX.TriggerServerCallback('esx_skin:getPlayerSkin', function(skin, jobSkin)

        if skin.sex == 0 then
          local model = GetHashKey("s_m_y_sheriffb_01")
      ...
      if data.current.value == 'bcso3_wear_freemode' then

        ESX.TriggerServerCallback('esx_skin:getPlayerSkin', function(skin, jobSkin)

        if skin.sex == 0 then
          local model = GetHashKey("s_m_y_sheriffk9_01")
      ...
      if data.current.value == 'bcso4_wear_freemode' then

        ESX.TriggerServerCallback('esx_skin:getPlayerSkin', function(skin, jobSkin)

        if skin.sex == 0 then
          local model = GetHashKey("s_m_m_lssheriffdick_01")
      ...
      if data.current.value == 'bcso5_wear_freemode' then

        ESX.TriggerServerCallback('esx_skin:getPlayerSkin', function(skin, jobSkin)

        if skin.sex == 0 then
          local model = GetHashKey("s_m_y_seb_01")
      ...
      if data.current.value == 'bcso6_wear_freemode' then

        ESX.TriggerServerCallback('esx_skin:getPlayerSkin', function(skin, jobSkin)

        if skin.sex == 0 then
          local model = GetHashKey("s_m_y_ciasec_01")
      ...
      if data.current.value == 'cadet_wear_freemode' then

        ESX.TriggerServerCallback('esx_skin:getPlayerSkin', function(skin, jobSkin)

        if skin.sex == 0 then
          local model = GetHashKey("s_m_y_copc_01")
      ...
      if data.current.value == 'polmoto_wear_freemode' then

        ESX.TriggerServerCallback('esx_skin:getPlayerSkin', function(skin, jobSkin)

        if skin.sex == 0 then
          local model = GetHashKey("s_m_y_copb_01")
      ...
      if data.current.value == 'k9_wear_freemode' then

        ESX.TriggerServerCallback('esx_skin:getPlayerSkin', function(skin, jobSkin)

        if skin.sex == 0 then
          local model = GetHashKey("s_m_y_copk9_01")
      ...
      if data.current.value == 'dick_wear_freemode' then

        ESX.TriggerServerCallback('esx_skin:getPlayerSkin', function(skin, jobSkin)

        if skin.sex == 0 then
          local model = GetHashKey("s_m_m_dick_01")
      ...
      if data.current.value == 'swat_wear_freemode' then
        ...
        if skin.sex == 0 then
          ...
          local model = GetHashKey("s_f_y_swat_01")
     ...
     if data.current.value == 'statepd_wear_freemode' then
        ESX.TriggerServerCallback('esx_skin:getPlayerSkin', function(skin, jobSkin)
        ...
        if skin.sex == 0 then
          ...
          local model = GetHashKey("s_f_y_hwaycop_01")
      ...
      if data.current.value == 'statepd2_wear_freemode' then
        ESX.TriggerServerCallback('esx_skin:getPlayerSkin', function(skin, jobSkin)

        if skin.sex == 0 then

          local model = GetHashKey("s_m_y_hwaycop_02")
          ...
          local model = GetHashKey("s_f_y_hwaycop_02")
...
if data.current.value == 'statepd3_wear_freemode' then
        ESX.TriggerServerCallback('esx_skin:getPlayerSkin', function(skin, jobSkin)

        if skin.sex == 0 then

          local model = GetHashKey("s_m_y_sahpswat_01")
      ...
      if data.current.value == 'ranger_wear_freemode' then
        ESX.TriggerServerCallback('esx_skin:getPlayerSkin', function(skin, jobSkin)
        ...
        if skin.sex == 0 then
          ...
          local model = GetHashKey("s_f_y_ranger_01")
...
function OpenVehicleSpawnerMenu(station, partNum)
  ...
  if Config.EnableSocietyOwnedVehicles then
    ...
    if PlayerData.job.grade_name == 'bcso' or PlayerData.job.grade_name == 'bcsohr' then
      table.insert(elements, { label = 'BCSO Stanier', value = 'sheriff' })
      table.insert(elements, { label = 'BCSO Granger', value = 'sheriff2' })
      table.insert(elements, { label = 'BCSO Interceptor', value = 'sheriff3' })
      table.insert(elements, { label = 'BCSO Buffalo', value = 'sheriff4' })
      table.insert(elements, { label = 'BCSO XLS', value = 'sheriff5' })
      table.insert(elements, { label = 'BCSO Contender', value = 'sheriff7' })
      table.insert(elements, { label = 'BCSO Hakuchou', value = 'sheriffb' })
      table.insert(elements, { label = 'BCSO K9 Interceptor', value = 'sheriffk9' })
      table.insert(elements, { label = 'BCSO Prisoner Transport Van', value = 'sherifft2' })
      table.insert(elements, { label = 'BCSO Retro Stanier', value = 'bcso' })
      table.insert(elements, { label = 'BCSO Retro Primier', value = 'bcso2' })
      table.insert(elements, { label = 'BCSO Retro Rancher XL', value = 'bcso3' })
    end

    if PlayerData.job.grade_name == "bcsohr" then
      table.insert(elements, { label = 'BCSO Unmarked Fugitive', value = 'sheriff6' })
      table.insert(elements, { label = 'BCSO Unmarked Sadler', value = 'sheriff61' })
      table.insert(elements, { label = 'BCSO Unmarked Seminole', value = 'sheriff62'})
      table.insert(elements, { label = 'BCSO Transport Bus', value = 'sheriffbus' })
      table.insert(elements, { label = 'BCSO ESU Ambulance', value = 'sheriffstockade' })
      table.insert(elements, { label = 'BCSO ESU Yosemite', value = 'sheriffesu' })
      table.insert(elements, { label = 'BCSO ESU Sandking', value = 'sheriffesu2' })
      table.insert(elements, { label = 'BCSO Sanchez', value = 'sheriffofr' })
      table.insert(elements, { label = 'BCSO Blazer', value = 'sheriffofr2' })
    end

    if PlayerData.job.grade_name == 'recruit' then
      table.insert(elements, { label = 'LSPD Stanier', value = 'police' })
      table.insert(elements, { label = 'LSPD Merit', value = 'police6'})
      -- table.insert(elements, { label = 'LSPD 1st Generation Stanier', value = 'police8'})
      -- table.insert(elements, { label = 'LSPD Solair', value = 'police12'})
      -- table.insert(elements, { label = 'LSPD Radius', value = 'police13'})
    end
    ...
    if PlayerData.job.grade_name == 'officer' then
      ...
      -- table.insert(elements, { label = 'LSPD Solair', value = 'police12'})
      -- table.insert(elements, { label = 'LSPD Radius', value = 'police13'})
      table.insert(elements, { label = 'LSPD Interceptor', value = 'police3'})
      table.insert(elements, { label = 'LSPD Buffalo', value = 'police2'})
      table.insert(elements, { label = 'LSPD Gresley', value = 'police5'})
      -- table.insert(elements, { label = 'LSPD Pinnacle', value = 'police9'})
      table.insert(elements, { label = 'LSPD Oracle', value = 'police11'})
    end

    if PlayerData.job.grade_name == 'corporal' then
      table.insert(elements, { label = 'LSPD Stanier', value = 'police' })
      table.insert(elements, { label = 'LSPD Merit', value = 'police6'})
      -- table.insert(elements, { label = 'LSPD 1st Generation Stanier', value = 'police8'})
      -- table.insert(elements, { label = 'LSPD Solair', value = 'police12'})
      ...
      -- table.insert(elements, { label = 'LSPD Pinnacle', value = 'police9'})
      table.insert(elements, { label = 'LSPD Oracle', value = 'police11'})
      table.insert(elements, { label = 'LSPD Jackal', value = 'pjackal'})
    end
    ...
    if PlayerData.job.grade_name == 'sergeant' then
      ...
      table.insert(elements, { label = 'LSPD Oracle', value = 'police11'})
      table.insert(elements, { label = 'LSPD Jackal', value = 'pjackal'})
      table.insert(elements, { label = 'LSPD Transport Van', value = 'policet2'})
      table.insert(elements, { label = 'LSPD Buffalo', value = 'police2'})
      table.insert(elements, { label = 'LSPD Buffalo S', value = 'police21'})
      table.insert(elements, { label = 'LSPD Unmarked Stanier', value = 'police4'})
      table.insert(elements, { label = 'LSPD Unmarked Buffalo', value = 'police42'})
      table.insert(elements, { label = 'LSPD Unmarked Interceptor', value = 'police43'})
      table.insert(elements, { label = 'LSPD Unmarked Gresley', value = 'police44'})
    end

    if PlayerData.job.grade_name == 'detective' or PlayerData.job.grade_name == 'lieutenant' or PlayerData.job.grade_name == 'fto' then
      table.insert(elements, { label = 'LSPD Stanier', value = 'police' })
      table.insert(elements, { label = 'LSPD Merit', value = 'police6'})
      -- table.insert(elements, { label = 'LSPD 1st Generation Stanier', value = 'police8'})
      -- table.insert(elements, { label = 'LSPD Solair', value = 'police12'})
      ...
      table.insert(elements, { label = 'LSPD Unmarked Interceptor', value = 'police43'})
      table.insert(elements, { label = 'LSPD Unmarked Gresley', value = 'police44'})
      table.insert(elements, { label = 'LSPD Unmarked Bullet', value = 'bulpolice3'})
      table.insert(elements, { label = 'LSPD Unmarked Pony', value = 'police14'})
      table.insert(elements, { label = 'LSPD Unmarked Exemplar', value = 'exemplar2'})
      table.insert(elements, { label = 'LSPD Unmarked Buffalo S', value = 'police42lx'})
      -- table.insert(elements, { label = 'LSPD Unmarked Uranus', value = 'uranuspolice'})
      table.insert(elements, { label = 'LSPD Unmarked Coquette', value = 'coqpolice2'})
      table.insert(elements, { label = 'LSPD Unmarked Infernus', value = 'infpolice2'})
      table.insert(elements, { label = 'LSPD Unmarked Faction', value = 'factfbi'})
    end

    if PlayerData.job.grade_name == 'captain' or PlayerData.job.grade_name == 'astchf' then
      table.insert(elements, { label = 'LSPD Stanier', value = 'police' })
      table.insert(elements, { label = 'LSPD Merit', value = 'police6'})
     -- table.insert(elements, { label = 'LSPD 1st Generation Stanier', value = 'police8'})
      -- table.insert(elements, { label = 'LSPD Solair', value = 'police12'})
      ...
      table.insert(elements, { label = 'LSPD Unmarked Infernus', value = 'infpolice2'})
      table.insert(elements, { label = 'LSPD Unmarked Faction', value = 'factfbi'})
      table.insert(elements, { label = 'LSPD Infernus', value = 'infpolice'})
      table.insert(elements, { label = 'LSPD Coquette', value = 'coqpolice'})
      table.insert(elements, { label = 'LSPD Bullet', value = 'bulpolice'})
      table.insert(elements, { label = 'LSPD Riot Van', value = 'riot'})
      table.insert(elements, { label = 'LSPD Insurgent', value = 'policeinsurgent'})
    end
    ...
    if PlayerData.job.grade_name == 'boss' then
      ...
      table.insert(elements, { label = 'BCSO Sanchez', value = 'sheriffofr' })
      table.insert(elements, { label = 'BCSO Blazer', value = 'sheriffofr2' })
      table.insert(elements, { label = 'SAHP Buffalo', value = 'hwaycar'})
      table.insert(elements, { label = 'SAHP Stanier', value = 'hwaycar2'})
      table.insert(elements, { label = 'SAHP Gresley', value = 'hwaycar3'})
      table.insert(elements, { label = 'SAHP Landstalker', value = 'hwaycar4'})
      table.insert(elements, { label = 'SAHP Granger', value = 'hwayswatcar'})
      table.insert(elements, { label = 'SAHP Sadler', value = 'hwayswatcar2'})
      table.insert(elements, { label = 'SAHP Western Motorcycle', value = 'policeb'})
      table.insert(elements, { label = 'SAHP Hakuchou Motorcycle', value = 'policeb2'})
      table.insert(elements, { label = 'SAHP Comet', value = 'hwaycarcmt'})
      table.insert(elements, { label = 'SAHP Dominator', value = 'hwaycarpursuit'})
      table.insert(elements, { label = 'SAHP Gauntlet', value = 'hwaycarpursuit2'})
      table.insert(elements, { label = 'SAHP Bullet', value = 'bulhway'})
      table.insert(elements, { label = 'SAHP Coquette', value = 'coqhway'})
      table.insert(elements, { label = 'SAHP Infernus', value = 'infhway'})
      table.insert(elements, { label = 'SAHP Faction', value = 'facthway'})
      table.insert(elements, { label = 'SAHP Uranus', value = 'uranushway2'})
      table.insert(elements, { label = 'FIB Buffalo', value = 'fbi'})
      table.insert(elements, { label = 'FIB Granger', value = 'fbi2'})
      table.insert(elements, { label = 'FIB Washington', value = 'fbiold'})
      table.insert(elements, { label = 'FIB Karuma', value = 'fbir'})
      table.insert(elements, { label = 'FIB Karuma Armored', value = 'fbira'})
      table.insert(elements, { label = 'FIB Cognoscenti', value = 'fbir2'})
      table.insert(elements, { label = 'FIB Cognoscenti Armored', value = 'fbir2a'})
      table.insert(elements, { label = 'FIB XLS', value = 'fbir3'})
      table.insert(elements, { label = 'FIB XLS Armored', value = 'fbir3a'})
      table.insert(elements, { label = 'FIB BeeJay XL', value = 'fbit'})
      table.insert(elements, { label = 'FIB Insurgent', value = 'fbiinsurgent'})
    end
        ...
        ESX.UI.Menu.Open(
          'default', GetCurrentResourceName(), 'citizen_interaction',
          {
            ...
            elements = {
              ...
              {label = 'Imprison',   value ='federal'},
              {label = 'Suspend Concealed Carry License',            value = 'license_weapon_remove'},
              {label = 'Suspend Motorcycle License',            value = 'license_moto_remove'},
              {label = 'Suspend CDL License',            value = 'license_camion_remove'},
              {label = 'Suspend Drivers License',            value = 'license_voiture_remove'},
              {label = 'Suspend Learners Permit',            value = 'license_code_remove'}
            },
          },
          function(data2, menu2)
            ...
            if distance ~= -1 and distance <= 3.0 then
              ...
              if data2.current.value == 'shackle' then
                TriggerServerEvent('esx_policejob:shackle', GetPlayerServerId(player))
              end

              if data2.current.value == 'gag' then
                TriggerServerEvent('esx_policejob:gag', GetPlayerServerId(player))
              end
              ...
              if (DoesEntityExist(ped) and not IsEntityDead(ped)) then 
                ...
                if (IsPedSittingInAnyVehicle(ped)) then 
                  ...
                  if (GetPedInVehicleSeat(vehicle, -1) == ped) then 
                      TriggerEvent('esx:showNotification', '~g~Vehicle Impounded')
                      SetEntityAsMissionEntity(vehicle,  false,  true)
                      DeleteVehicle(vehicle)
                  else 
                    TriggerEvent('esx:showNotification', '~r~Could not impound vehicle')
                  end 
                else
                  local playerPed = GetPlayerPed(-1)
  ...
  ESX.UI.Menu.Open(
    'default', GetCurrentResourceName(), 'federal',
    {
      ...
      elements = {
        ...
        {label = '55 months',  value = 55},
        {label = '60 months',  value = 60},
        {label = '65 months',  value = 65},
        {label = '70 months',  value = 70},
        {label = '75 months',  value = 75},
        {label = '80 months',  value = 80},
        {label = '85 months',  value = 85},
        {label = '90 months',  value = 90},
        {label = '95 months',  value = 95},
        {label = '100 months',  value = 100},
        {label = '105 months',  value = 105},
        {label = '110 months',  value = 110},
        {label = '115 months',  value = 115},
...
AddEventHandler('jail:teleportPlayer', function(amount)
  if IsHandcuffed then
    ...
    TriggerEvent('chatMessage', '^4[JAIL]', {0,0,0}, "Your sentence is : ^1".. (tonumber(amount)/60) .." month(s)!")
    clearPed()
    Wait(500)
    ...
    Citizen.CreateThread(function()
      while (amount > 0) do
        if amount == 240 then
          TriggerEvent('chatMessage', '^4[JAIL]', {0,0,0}, "Remaining time: ^1".. (tonumber(amount)/60) .." minutes !")
        elseif amount == 180 then
          TriggerEvent('chatMessage', '^4[JAIL]', {0,0,0}, "Remaining time: ^1".. (tonumber(amount)/60) .." minutes !")
        elseif amount == 120 then
          TriggerEvent('chatMessage', '^4[JAIL]', {0,0,0}, "Remaining time: ^1".. (tonumber(amount)/60) .." minutes !")
        elseif amount == 60 then
          TriggerEvent('chatMessage', '^4[JAIL]', {0,0,0}, "Remaining time: ^1".. (tonumber(amount)/60) .." minute !")
        else
        ...
        if (GetDistanceBetweenCoords(LastPosX, LastPosY, LastPosZ, 1680.06994628906,2512.80004882813,46.2684020996094, true) > 100.0001) then
            SetEntityCoords(GetPlayerPed(-1), tonumber("1680.07"), tonumber("2512.8"), tonumber("45.4649"))
            TriggerEvent('chatMessage', '^4[JAIL]', {0,0,0}, "Time extended for unlawful escape attempt!")
        end
        Citizen.Wait(1000)
        amount = amount - 1
...
RegisterNetEvent('esx_policejob:shackle')
AddEventHandler('esx_policejob:shackle', function()
...
RegisterNetEvent('esx_policejob:gag')
AddEventHandler('esx_policejob:gag', function()
...
AddEventHandler('esx_policejob:panicButton', function(alert)
    if PlayerData.job ~= nil and PlayerData.job.name == 'police' then
...
Citizen.CreateThread(function()
  while true do
    ...
    Citizen.Wait(0)
      if IsControlJustReleased(1, Keys['F10']) and PlayerData.job.name == 'police' then
        TriggerServerEvent("esx_policejob:panicButtonTrigger", 'filler', 'filler', 'yes')
        local playerPed   = GetPlayerPed(-1)
        local coords      = GetEntityCoords(playerPed)
          
          TriggerServerEvent('esx_phone:send', 'police', '~r~Panic Button Activated - All Units Respond', true, {
            x = coords.x,
            y = coords.y,
            z = coords.z
          })
         TriggerServerEvent('esx_phone:send', 'ambulance', '~r~Panic Button Activated - All Units Respond', true, {
            x = coords.x,
            y = coords.y,
            z = coords.z
          })
