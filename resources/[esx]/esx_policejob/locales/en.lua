Locales['en'] = {
  ...
  ['police_wear'] = '(MP Model) LSPD Uniform',
  ['sheriff_wear'] = 'LSPD Uniform',
  ['cadet_wear'] = 'LSPD Cadet Uniform',
  ['lieutenant_wear'] = 'LSPD Motorcycle Uniform',
  ['k9_wear'] = 'LSPD K9 Uniform',
  ['dick_wear'] = 'LSPD Detective Uniform',
  ['swat_wear'] = 'LSPD SWAT Uniform',
  ['statepd_wear'] = 'SAHP Motorcycle Uniform',
  ['statepd2_wear'] = 'SAHP Uniform',
  ['statepd3_wear'] = 'SAHP SWAT Uniform',
  ['ranger_wear'] = 'SAPR Uniform',
  ['fbi_wear'] = 'FBI Agent Uniform',
  ['fbi2_wear'] = 'FBI Agent Uniform 2',
  ['fbi3_wear'] = 'FBI Agent Uniform 3',
  ['fbi4_wear'] = 'FBI Agent Uniform 4',
  ['fbi5_wear'] = 'FBI Response Uniform',
  ['fbi6_wear'] = 'FBI SWAT Uniform',
  ...
  ['traffic_offense'] = 'traffic Offenses',
  ['minor_offense'] = 'misdemeanors',
  ['average_offense'] = 'felonies',
  ['major_offense'] = 'other',
  ['fine_total'] = 'fine: ',
  -- Vehicle Info Menu
  ['plate'] = 'Plate: ',
  ...
  ['veste_wear'] = '(MP Model) Wear Vest',
  ['gilet_wear'] = '(MP Model) Remove Vest',
}
