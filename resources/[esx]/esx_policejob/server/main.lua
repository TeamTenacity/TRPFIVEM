...
RegisterServerEvent('esx_policejob:gag')
AddEventHandler('esx_policejob:gag', function(target)
  TriggerClientEvent('esx_policejob:gag', target)
end)

RegisterServerEvent('esx_policejob:shackle')
AddEventHandler('esx_policejob:shackle', function(target)
  TriggerClientEvent('esx_policejob:shackle', target)
end)
...
RegisterServerEvent('esx_policejob:panicButtonTrigger')
AddEventHandler('esx_policejob:panicButtonTrigger', function(street1, street2, sex)
  TriggerClientEvent("esx_policejob:panicButton", "filler")
end)
...
function deleteLicense(owner, license)
    ...
    print('License Removed - '..owner)
    print('License Removed - '..license)
...
AddEventHandler('esx_policejob:deletelicense', function(target, license)
  ...
  TriggerClientEvent('esx:showNotification', sourceXPlayer.source, 'You have ~r~suspended ~w~ '..targetXPlayer.name .. "'s "..text)
  TriggerClientEvent('esx:showNotification', targetXPlayer.source, '~r~' .. sourceXPlayer.name .. ' has suspended your '.. text)
  local identifier = GetPlayerIdentifiers(target)[1]
...
local xPlayer = ESX.GetPlayerFromId(source)
  ...
  xPlayer.addInventoryItem('burger', amount/60)
