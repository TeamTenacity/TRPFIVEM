...
Config.NPCJobEarnings             = { min = 170, max = 400 }
Config.Locale                     = 'en'

Config.Zones = {
  MecanoActions = {
    Pos   = {x = 98.436, y = 6621.391, z = 31.20},
  ...
  Garage = {
    Pos   = {x = 102.00, y = 6616.00, z = 31.20},
    Size  = {x = 1.5, y = 1.5, z = 1.0},
    Color = {r = 204, g = 204, b = 0},
    Type  = 25
  },
  ...
  Craft = {
    Pos   = {x = 107.90, y = 6629.30, z = 30.55},
    Size  = {x = 1.5, y = 1.5, z = 1.0},
    Color = {r = 204, g = 204, b = 0},
    Type  = 25
  },
  ...
  VehicleSpawnPoint = {
    Pos   = {x = 132.00, y = 6656.00, z = 30.80},
    Size  = {x = 1.5, y = 1.5, z = 1.0},
    Type  = -1,
    Heading = 220.00
  },
  ...
  VehicleDeleter = {
    Pos   = {x = 142.50, y = 6652.00, z = 30.00},
  ...
  VehicleDelivery = {
    Pos   = { x = 401.006, y = -1632.267, z = 28.6919 },
