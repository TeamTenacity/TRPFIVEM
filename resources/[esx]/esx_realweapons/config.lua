...
Config.RealWeapons = {
	...
	{name = 'WEAPON_FLASHLIGHT', 		bone = 24818, x = 0.0, y = 0.0, z = 0.0, xRot = 0.0, yRot = 0.0, zRot = 0.0, category = 'melee', 		model = 'p_cs_police_torch_s'},
	...
	{name = 'WEAPON_ASSAULTRIFLE', 		bone = 51826, x = -0.01, y = 0.10, z = 0.07, xRot = -115.0, yRot = 0.0, zRot = 0.0, category = 'assault', 	model = 'w_ar_assaultrifle'},
