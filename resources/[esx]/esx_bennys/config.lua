...
Config.Zones = {
    ls1 = {
        Pos   = { x = -212.487, y = -1325.052, z = 29.822},
        Size  = {x = 3.0, y = 3.0, z = 0.2},
        Color = {r = 204, g = 204, b = 0},
        Marker= 1,
        Name  = "Benny's Original Autoworks",
...
--		upgrades = _U('upgrades'),
	...
	cosmetics = {
		...
		modShifterLeavers   = 'Shifters',
		modAPlate    		= 'Rear Signs',
		modSpeakers    		= 'Speakers',
		modTrunk    		= 'Trunk',
		modHydrolic    		= 'Hydraulics',
