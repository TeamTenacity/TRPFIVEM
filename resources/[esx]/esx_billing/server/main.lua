					...
					if xPlayer.get('money') >= amount then
						...
						MySQL.Async.execute(
							...
							function(rowsChanged)
								...
								TriggerClientEvent('esx:showNotification', foundPlayer.source, 'Payment recieved for $' .. amount)
				...
				TriggerEvent('esx_addonaccount:getSharedAccount', target, function(account)
					...
					MySQL.Async.execute(
						...
						function(rowsChanged)
							...
							if foundPlayer ~= nil then
								TriggerClientEvent('esx:showNotification', foundPlayer.source, 'Payment recieved for ~g~$' .. amount)
							end
