Locales['en'] = {
  ...
  ['sheriff_wear'] = 'Fugitive Recovery Agent',
  ['cadet_wear'] = 'Uniformed Security',
  ['lieutenant_wear'] = 'Armed Rapid Response Team',
  ['commandant_wear'] = 'Armed Rapid Response Team 2',
  ['detective_wear'] = 'Personal Protective Unit',
  ...
  ['cone'] = 'cone',
  ['barrier'] = 'barrier',
  ['barrier2'] = 'Merryweather Barrier',
  ['barrier3'] = 'Merryweather Barrier (No Sign)',
  ...
  ['quantity'] = 'quantity',
  ['inventory'] = 'inventory',
  ['merryweather_stock'] = 'Merryweather Stock',
  -- Misc
  ['remove_object'] = 'press ~INPUT_CONTEXT~ to delete the object',
  ['map_blip'] = 'Merryweather Docks',
  -- Notifications
  ['from'] = '~s~ from ~b~',
  ...
  ['alert_merryweather'] = 'Merryweather Call',
  -- Authorized Vehicles
