	...
	SetTimeout(7500, function()
		...
		if PlayersSellingMeth[source] == true then
			...
			if poochQuantity == 0 then
				...
				if CopsConnected == 0 then
                    xPlayer.addAccountMoney('black_money', 1450)
                    TriggerClientEvent('esx:showNotification', source, _U('sold_one_meth'))
                elseif CopsConnected == 1 then
                    xPlayer.addAccountMoney('black_money', 2200)
                    TriggerClientEvent('esx:showNotification', source, _U('sold_one_meth'))
                elseif CopsConnected == 2 then
                    xPlayer.addAccountMoney('black_money', 2950)
                    TriggerClientEvent('esx:showNotification', source, _U('sold_one_meth'))
                elseif CopsConnected == 3 then
                    xPlayer.addAccountMoney('black_money', 3700)
                    TriggerClientEvent('esx:showNotification', source, _U('sold_one_meth'))
                elseif CopsConnected == 4 then
                    xPlayer.addAccountMoney('black_money', 4450)
                    TriggerClientEvent('esx:showNotification', source, _U('sold_one_meth'))
                elseif CopsConnected == 5 then
                    xPlayer.addAccountMoney('black_money', 5200)
                    TriggerClientEvent('esx:showNotification', source, _U('sold_one_meth'))
                elseif CopsConnected >= 6 then
                    xPlayer.addAccountMoney('black_money', 5950)
                    TriggerClientEvent('esx:showNotification', source, _U('sold_one_meth'))
                end
	...
	SetTimeout(7500, function()
		...
		if PlayersSellingWeed[source] == true then
			...
			if poochQuantity == 0 then
                ...
                elseif CopsConnected == 1 then
                    xPlayer.addAccountMoney('black_money', 1175)
                    TriggerClientEvent('esx:showNotification', source, _U('sold_one_weed'))
                elseif CopsConnected == 2 then
                    xPlayer.addAccountMoney('black_money', 1250)
                    TriggerClientEvent('esx:showNotification', source, _U('sold_one_weed'))
                elseif CopsConnected == 3 then
                    xPlayer.addAccountMoney('black_money', 1325)
                    TriggerClientEvent('esx:showNotification', source, _U('sold_one_weed'))
                elseif CopsConnected >= 4 then
		...
		if PlayersSellingOpium[source] == true then
			...
			if poochQuantity == 0 then
                ...
                elseif CopsConnected == 4 then
                    ...
                    TriggerClientEvent('esx:showNotification', source, _U('sold_one_opium'))
                elseif CopsConnected >= 5 then
                    xPlayer.addAccountMoney('black_money', 5550)
                    TriggerClientEvent('esx:showNotification', source, _U('sold_one_opium'))
                end
...
ESX.RegisterUsableItem('coke_pooch', function(source)
    ...
    TriggerClientEvent('esx:showNotification', _source, 'You used 1x ~r~Cocaine')
...
ESX.RegisterUsableItem('vest', function(source)
	...
	TriggerClientEvent('esx_drugs:vest', _source)
    TriggerClientEvent('esx:showNotification', _source, 'You used 1x ~b~Kevlar Vest')
...
ESX.RegisterUsableItem('cig', function(source)
	...
	TriggerClientEvent('esx_drugs:cig', _source)
    TriggerClientEvent('esx:showNotification', _source, 'You used 1x ~b~cigarrette')
