local Keys = {
    ["ESC"] = 322, ["F1"] = 288, ["F2"] = 289, ["F3"] = 170, ["F5"] = 166, ["F6"] = 167, ["F9"] = 168, ["F8"] = 169, ["F9"] = 56, ["F10"] = 57,
...
function buy_animal()
    ...
    local price = price
    local elements = {}
    table.insert(elements, {label = _U('dog') .. '- ',             					value = "chien",	price = 1})		
    table.insert(elements, {label = _U('cat') .. '- ',             					value = "chat", price = 1})
    table.insert(elements, {label = _U('wolf') .. '- ',             					value = "loup", price = 1})
    table.insert(elements, {label = _U('bunny') .. '- ',             					value = "lapin",	price = 1})
    table.insert(elements, {label = _U('husky') .. '- ',             					value = "husky", price = 1})
    table.insert(elements, {label = _U('pig') .. '- ',             					value = "cochon", price = 1})
    table.insert(elements, {label = _U('poodle') .. '- ',             					value = "caniche", price = 1})
    table.insert(elements, {label = _U('pug') .. '- ',             					value = "carlin", price = 1})
    table.insert(elements, {label = _U('retriever') .. '- ',             					value = "retriever", price = 1})
    table.insert(elements, {label = _U('asatian') .. '- ',             					value = "berger", price = 1})
    table.insert(elements, {label = _U('westie') .. '- ',             					value = "westie", price = 1})
