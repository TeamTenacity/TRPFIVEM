...
AddEventHandler('thiefInProgressPolice', function(street1, street2, veh, sex)
	if veh == "NULL" then
		TriggerClientEvent("outlawNotify", -1, "~r~Police vehicle stolen between ~w~"..street1.."~r~ and ~w~"..street2)
	else
		TriggerClientEvent("outlawNotify", -1, "~r~Police vehicle stolen, Reported as a ~w~"..veh.." ~r~ between ~w~"..street1.."~r~ and ~w~"..street2)
	end
end)
...
AddEventHandler('thiefInProgressS1Police', function(street1, veh, sex)
	if veh == "NULL" then
		TriggerClientEvent("outlawNotify", -1, "~r~Police vehicle stolen on ~w~"..street1)
	else
		TriggerClientEvent("outlawNotify", -1, "~r~Police vehicle stolen, Reported as a ~w~"..veh.." ~r~on ~w~"..street1)
	end
end)
...
AddEventHandler('thiefInProgress', function(street1, street2, veh, sex)
	if veh == "NULL" then
		TriggerClientEvent("outlawNotify", -1, "~r~Vehicle Stolen between ~w~"..street1.."~r~ and ~w~"..street2)
	else
		TriggerClientEvent("outlawNotify", -1, "~r~Vehicle Stolen, Reported as a ~w~"..veh.." ~r~between ~w~"..street1.."~r~ and ~w~"..street2)
	end
end)
...
AddEventHandler('thiefInProgressS1', function(street1, veh, sex)
	if veh == "NULL" then
		TriggerClientEvent("outlawNotify", -1, "~r~Vehicle Stolen on ~w~"..street1)
	else
		TriggerClientEvent("outlawNotify", -1, "~r~Vehicle Stolen, Reported as a ~w~"..veh.." ~r~on ~w~"..street1)
	end
end)

RegisterServerEvent('meleeInProgress')
AddEventHandler('meleeInProgress', function(street1, street2, sex)
	TriggerClientEvent("outlawNotify", -1, "~r~Fighting reported between ~w~"..street1.."~r~ and ~w~"..street2)
end)

RegisterServerEvent('meleeInProgressS1')
AddEventHandler('meleeInProgressS1', function(street1, sex)
	TriggerClientEvent("outlawNotify", -1, "~r~Fighting reported at ~w~"..street1)
end)


RegisterServerEvent('gunshotInProgress')
AddEventHandler('gunshotInProgress', function(street1, street2, sex)
	TriggerClientEvent("outlawNotify", -1, "~r~Gunfire reported between ~w~"..street1.."~r~ and ~w~"..street2)
end)

RegisterServerEvent('gunshotInProgressS1')
AddEventHandler('gunshotInProgressS1', function(street1, sex)
	TriggerClientEvent("outlawNotify", -1, "~r~Gunfire reported on ~w~"..street1)
end)
