                ...
                if not holdingup then
                    ...
                    if(Vdist(pos.x, pos.y, pos.z, pos2.x, pos2.y, pos2.z) < 1.0)then
                        ...
                        if IsControlJustReleased(1, 51) then
                                local weaponStealeableList = {453432689, 1593441988, 584646201, 2578377531, 324215364, 3523564046, 137902532, 3249783761, 736523883, 4024951519, 322017674, 2210333304, 2937143193, 2634544996, 2144741730, 487013001, 2017895192, 3800352039, 2640438543, 2726580491, 1627465347, 3231910285, 2132975508, 984333226, 171789620, 3675956304, 4019527611, 1649403952, 317205821, 3173288789} -- https://www.se7ensins.com/forums/threads/weapon-and-explosion-hashes-list.1045035/ weapon's codes
