...
Config.Priority = {
    ["STEAM_0:1:101693487"] = 50,
    ["steam:76561198163652703"] = 25,
    ["STEAM_0:1:87210148"] = 50,
    ["steam:76561198031904598"] = 85,
    ["ip:71.228.127.233"] = 85,
	["steam:76561198031904598"] = 85,
...
Config.Language = {
    ...
    pos = "[HPRP Auto Queue] You are %d/%d in queue",
    connectingerr = "Error adding you to connecting list",
    banned = "You are banned, you may appeal it at www.Troleplay.com | Reason: %s",
    steam = "Error: Steam must be running",
    prio = "You must be whitelisted to join this server. You may apply at www.Troleplay.com"
}
-----------------------------------------------------------------------------------------------------------------------
